//Objective: To Create A Member Database And Retrieve Records From It.
//Problem: A Member Of A Golf Club Is Having The Following Attributes And Methods. Create A Class To Represent A Member Of The Club. Consider Appropriate
//Constructors Or Setter Methods To Set The Details And A Method Display() To Display The Details Of One Member.
//Create An Array Member[] Of Member Objects And Set The Details. The Details Of The Member Table May Look Like The Following. 
...
class Date
{
    ...
    {
        return this.year<d1.year||(this.year == d1.year&&(getMonthValue(this.month)<getMonthValue(d1.month)||(getMonthValue(this.month)==getMonthValue(d1.month)
        && this.day < d1.day)));
    }
    public int getDay()
    {
...
class Member
{
    ...
    public void display()
    {
        System.out.print(memberId+"\t\t"+lastName+"\t\t"+firstName+"\t\t"+handicap+"\t\t"+gender+"\t"+team+"\t"+memberType+"\t\t"+coach+"\t"+phone+
...
public class Project
{
    public static void main(String[] args)
    {
        ...
        members[0]  = new Member(118, "McKenzi", "Melissa", 30, 'F', "Junior", 153, 963270, new Date(28, "May", 2005));
...
//Serial Number-61
//Subject- Minor Project II Semester 2024